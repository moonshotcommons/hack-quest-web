  ...
  return (
    ...
    >
      <div className="relative h-[6px] rounded-t-[4.8px] bg-[#fafafa]">
        <div
          className="body-xs absolute right-[9px] top-[9px]  z-[10] cursor-pointer rounded-[0.5rem] font-next-book text-[#E3E3E3]"
          onClick={async (e) => {
            try {
      ...
      {isPlayground ? (
        <div className="relative w-full flex-1">
          <div className="absolute left-0 top-0 h-full w-full overflow-auto">
            <SyntaxHighlighter
              ...
              language={language}
              className="scroll-wrap-x scroll-wrap-y mt-[0!important] h-full rounded-t-[0!important]"
              showLineNumbers
            >
              {codeContent}
            </SyntaxHighlighter>
        ...
        <SyntaxHighlighter
          style={theme === Theme.Dark ? oneDark : oneLight}
          language={language}
          className="scroll-wrap-x scroll-wrap-y mt-[0!important] h-[calc(100%-20px)] rounded-t-[0!important]"
          showLineNumbers
        >
          {codeContent}
        </SyntaxHighlighter>

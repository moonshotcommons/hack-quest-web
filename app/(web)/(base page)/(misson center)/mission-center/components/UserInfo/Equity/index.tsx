...
const Equity: React.FC<EquityProp> = ({ level }) => {
    ...
    if (level > v.level) {
      return (
        <li key={i} className={`flex items-center leading-[23px] pl-[20px]`}>
          <span className="w-[5px] h-[5px] rounded-[50%] bg-neutral-black"></span>
      ...
      return (
        <li
          key={i}
          className={`flex items-center leading-[23px] pl-[20px] text-neutral-medium-gray ${
            !showMore && 'hidden'
          }`}
        >
  ...
  return (
    <div className="flex flex-col items-start w-full mt-[40px]">
      <div className="flex items-center gap-[5px] text-neutral-black leading-[23px] mb-[5px]">
        ...
        <div className="w-[40px] h-[40px] flex-center  relative left-[-15px] cursor-pointer group">
          ...
          >
            <div className="flex mt-[-15px] pb-[5px] border-b border-neutral-medium-gray">
      ...
      <div className="flex justify-end w-full pt-[4px]">
        <span
          className="text-[12px] text-neutral-black underline cursor-pointer"

...
const MantleInfo: React.FC<MantleInfoProp> = ({}) => {
  ...
  return (
    <div className="flex justify-between gap-[50px] mb-[30px]">
      ...
      <div
        className={`h-fit flex gap-[40px] px-[30px] py-[20px] border border-neutral-medium-gray rounded-[10px] font-next-book ${
        ...
        <div className="flex-1 flex flex-col justify-between">
          ...
          {showAll && (
            <div className="flex justify-between">
              <Button
                className={`w-[120px] h-[34px] text-neutral-black text-[16px] p-0

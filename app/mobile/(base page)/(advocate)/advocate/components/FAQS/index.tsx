...
const FAQData = [
  {
    problem:
      'I am currently an advocate for other communities. Am I still eligible to be an advocate for HackQuest? ',
    answer:
  ...
  {
    problem:
      'Do I have to be a Web 3.0 developer to be qualified as an advocate?',
    answer:
  ...
  {
    problem:
      'What do I need to prepare for events? Do I have to prepare materials by myself?',
    ...
    <div className="container mx-auto flex max-w-[1280px] justify-between gap-20 py-[6.25rem]">
      <div className="flex w-[400px] max-w-[400px] flex-col gap-10">
        ...
        <p className="body-l tracking-tighter text-neutral-medium-gray">
          For more questions, join our Discord / Telegram and DM your question
          directly!
        </p>

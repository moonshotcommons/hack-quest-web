...
import { CustomComponent, CustomType, QuizAType, QuizBType, QuizType } from '@/components/ComponentRenderer/type';

interface MobUgcCustomRendererProps {
  // children: ReactNode
  parent: any;
  component: any;
...
const MobUgcCustomRenderer: FC<MobUgcCustomRendererProps> = (props) => {
...
export default MobUgcCustomRenderer;

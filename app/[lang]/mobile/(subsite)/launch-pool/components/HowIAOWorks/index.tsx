...
const HowIAOWorks: FC<HowIAOWorksProps> = async ({ lang }) => {
  ...
  return (
    <div className="mt-5 w-full py-10">
      <h2 className="text-h2-to-setting-modal-bg mb-10 text-center text-neutral-black">{t('howIAOWorks')}</h2>
            ...
            return (
              <div key={item.title} className="flex flex-1 gap-4 px-6">
                ...
                <div className="flex flex-col gap-5 py-5">
                  ...
                  <p className="body-s text-neutral-medium-gray">{t(item.desc)}</p>
                  {item.buttonText && (

  ...
  return (
    <div className="flex h-[682px] w-full flex-col items-center bg-neutral-black px-5 py-10">
      <div className="mt-[193px] flex flex-col items-center gap-8">
        <h1 className="text-h1-mob text-center capitalize text-neutral-white">
          {`HackQuest ${t('launchpool')}`}
        </h1>
        <div className="flex items-center gap-6">
          <span className="body-m-bold text-neutral-light-gray">
            {t('poweredBy')}
          </span>
          <Image
        ...
        <p className="body-m-bold max-w-[257px] text-center text-yellow-primary">
          {t('topBannerDesc')}
        </p>
      </div>

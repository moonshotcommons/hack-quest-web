      ...
      <div className=" scroll-wrap-y  w-[808px] rounded-[10px] bg-neutral-white px-[137px]  pb-[40px] pt-[60px]  text-neutral-black">
        <div className="">
          ...
          <p className="body-m my-[24px] text-center text-neutral-off-black">
            If you choose to unstake now, your fuel under this stake will be removed. If there is no stake from you in this project, your
            fuel will be zeroed and you will be ineligible to participate in this project IAO anymore.
          </p>

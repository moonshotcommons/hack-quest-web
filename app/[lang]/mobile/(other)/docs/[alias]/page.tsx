    ...
    <div className="flex min-h-[calc(100vh-64px)] w-full justify-center">
      <div className="w-full">
        ...
        <div className="flex flex-col">
          <ComponentRendererProvider type={PageType.BLOG} CustomComponentRenderer={DocsCustomRenderer} isMobile={true}>
        ...
        <div className="mt-10 h-[1px] w-full bg-neutral-light-gray"></div>
        <div className="body-s mx-auto mb-[105px] mt-4 flex w-full justify-between text-neutral-medium-gray">

...
interface OwnerGroupDetailProps {
  ...
  userId: string;
  hackathonId: string;
  config: { type?: 'Solo or Group' | 'Solo Only' | 'Group Only'; minSize?: number; maxSize?: number };
}
    ...
    <div className="flex w-full flex-col gap-3">
      ...
      <div className="flex justify-between gap-1 rounded-[16px] bg-neutral-off-white p-3 text-left">
        ...
        <p className="button-text-s leading-[160%] text-neutral-medium-gray">
          This hackathon let’s you have upto {config.maxSize} teammates. Share the code below to add teammates.
        </p>
      </div>
      <div className="my-1 flex flex-col gap-1">
        <p className="body-s text-left text-neutral-rich-gray">Team Code</p>
        <div className="body-s flex items-center justify-between gap-1 rounded-[16px] bg-yellow-extra-light px-6 py-3 leading-[160%] text-neutral-off-black">
          <span>{team.code}</span>

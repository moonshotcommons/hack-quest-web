      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-6">
          <div className="flex flex-col gap-4 text-left">
            <p className="body-s text-neutral-off-black">Please provide at least one contact information</p>
            ...
            <div className="flex flex-col gap-4">
              <p className="body-s">{`By filling in some additional contact information like Telegram and Discord, you'll be invited to join

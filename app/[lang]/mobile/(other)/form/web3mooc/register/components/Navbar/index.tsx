...
const SubmitLayoutNavbar: FC<SubmitLayoutNavbarProps> = (props) => {
  ...
  return (
    <nav className="max-w-screen relative flex h-[64px] w-full items-center bg-neutral-white px-[40px] text-neutral-white">
      ...
      <div className="flex w-[123px] cursor-pointer items-center justify-end gap-[20px] text-neutral-off-black">
        ...
        <span className="flex items-center gap-2 capitalize" onClick={onExit}>

  ...
  return (
    <Modal open={open} onClose={() => setOpen(false)}>
      <div className="flex w-full flex-col items-center  rounded-[16px] bg-neutral-white px-[1.25rem] py-[1.875rem]">
        ...
        <div className="body-s mb-[2.25rem] whitespace-pre-line text-neutral-rich-gray">
          <div>{t('hackathonVoting.tipsModalTitle')}</div>
          <div className="my-[.375rem]">
            <div>
              <span className="body-s-bold">{t('hackathonVoting.tipsModalTitle1')}</span>
              <span>{t('hackathonVoting.tipsModaltext1')}</span>
            </div>
            <div>
              <span className="body-s-bold">{t('hackathonVoting.tipsModalTitle2')}</span>
              <span>{t('hackathonVoting.tipsModaltext2')}</span>
            </div>
            <div>
              <span className="body-s-bold">{t('hackathonVoting.tipsModalTitle3')}</span>
              <span>{t('hackathonVoting.tipsModaltext3')}</span>
            </div>
            <div>
              <span className="body-s-bold">{t('hackathonVoting.tipsModalTitle4')}</span>

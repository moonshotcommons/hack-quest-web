...
const SearchTxt: React.FC<SearchTxtProp> = ({ projects, keyword, handleReset }) => {
  ...
  return (
    <div className="mb-[2rem] mt-[1rem] flex flex-col items-center gap-[1.5rem]">
      {projects.length > 0 ? (
        <>
        ...
        <>
          ...
          <Button
            ghost
            className="button-text-m h-[3rem] w-[12.5rem] border-neutral-black p-0 uppercase text-neutral-black"
            onClick={handleReset}
          >

...
const tabsTriggerClassName =
  'p-0 relative text-lg text-neutral-off-black data-[state=active]:bg-transparent data-[state=active]:after:absolute data-[state=active]:after:left-0 data-[state=active]:after:-bottom-1 data-[state=active]:after:h-[3px] data-[state=active]:after:w-full data-[state=active]:after:bg-yellow-dark data-[state=active]:content-[""]';
...
export function ParticipatedContent() {
  ...
  return (
    <Tabs defaultValue="ongoing" className="mt-3 w-full" value={status} onValueChange={handleStatusChange}>
      ...
      <TabsContent className="mt-6" value="ongoing">

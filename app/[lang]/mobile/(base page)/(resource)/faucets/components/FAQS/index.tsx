  ...
  return (
    <div className="flex w-full flex-col gap-10 px-5 py-10">
      <div className="flex w-fit flex-col">
        <p className="text-h2 text-[1.375rem] capitalize text-neutral-off-black">{t('faucets.FAQS.title')}</p>
        <p className="body-xs mt-5 text-neutral-medium-gray"> {t('faucets.FAQS.description')}</p>
        ...
        {FAQData.map((item, index) => {
          return (
            ...
            >
              ...
              >
                <p className="body-m-bold text-neutral-rich-gray">{t(item.problem)}</p>

  ...
  return (
    ...
    >
      <div className="relative h-0 w-full flex-shrink-0 overflow-hidden pt-[46%]">
        <Image src={course.image || CourseCover} fill alt={course.title || course.name} className="object-cover" />
      </div>
      <div className="flex flex-col gap-[.75rem] p-[1.5rem]">
        <div className="flex gap-[.75rem]">
          <TrackTag track={course.track} />
        </div>
        <h2 className="body-l-bold line-clamp-2 text-neutral-off-black">{course.title || course.name}</h2>

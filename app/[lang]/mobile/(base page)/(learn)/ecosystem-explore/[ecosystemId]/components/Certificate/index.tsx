      ...
      <div className="flex flex-shrink-0 items-center gap-[.3125rem]">
        <div className="flex-1 flex-shrink-0">
          <div className="relative h-0 w-full overflow-hidden pt-[56.7%]">
            <Image src={CertificateCover} alt={''} fill className="object-cover" />
          </div>
          <div className="body-s-bold mt-[.75rem] text-center">Lvl 1. Learner</div>
        </div>
        {ecosystem?.level?.level > 1 && (
          <>
            ...
            <div className="flex-1 flex-shrink-0">
              <div className="relative h-0 w-full overflow-hidden pt-[56.7%]">
                <Image src={CertificateAcitveCover} alt={''} fill className="object-cover" />
              </div>
              <div className="body-s-bold mt-[.75rem] text-center">Lvl 2. Builder</div>
            </div>
          </>
        )}
      </div>

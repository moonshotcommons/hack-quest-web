  ...
  return (
    <div>
      ...
      <div className="body-s flex flex-col gap-[.625rem] text-neutral-rich-gray">
        <div>
          <p className="body-m-bold">NTU I&E x HackQuest MOOC</p>
          <div className="mt-2 flex flex-col gap-3">
            <p>
              NTU I&E x HackQuest MOOC is free and open to all individuals interested in Web3. The MOOC is designed to
              be universally accessible, featuring an online educational model that includes one to two-hour weekly
            ...
            <p>
              ...
              be eligible for proof of completion.
            </p>
            <p>
        ...
        <div className="mt-2">
          <p className="body-m-bold">Beyond MOOC: The Port63 Challenge</p>
          <div className="mt-2 flex flex-col gap-3">
            <p>
              ...
              perspectives, and analyse real-world challenges.
            </p>
            <p>
              {`The second edition is set to commence in August 2024, with completion of the MOOC as a prerequisite in the
              Web 3.0 Track. Teams comprising members from Singapore's Institutes of Higher Learning and Polytechnics,
              along with a mandatory NTU-affiliated member, are strongly encouraged to participate. This competition
              offers cash prizes, funding, and mentorship to support the realisation of innovative ideas. Stay tuned for
              more details!`}
            </p>
            <p>

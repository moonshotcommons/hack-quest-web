    ...
    <div className="flex flex-col gap-[32px] px-[40px]">
      ...
      <div className="scroll-wrap-y flex max-h-[500px] flex-col gap-[8px] rounded-[10px] border border-neutral-light-gray p-[20px]">
        ...
        <div className="body-s text-neutral-off-black">
          Your course ‘Course Name Course Name Course Name Course Name’ has passed the review. Here is the final comment from HackQuest
          team:
        </div>
        <div className="flex gap-[10px] p-[20px] text-neutral-rich-gray">
          <span className=" text-h4">“</span>
          <span className="body-xs">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas accumsan sit amet neque eu dapibus. Mauris vitae libero
            lectus. Vestibulum aliquet sem vel arcu tristique semper. Curabitur dapibus risus id sollicitudin viverra. Vivamus in tristique
            urna. Curabitur dictum fringilla ligula at commodo. Proin tincidunt purus at neque gravida, eu finibus magna venenati
          </span>
          <span className="text-h4 flex items-end">”</span>
        </div>
        <div className="body-s text-neutral-rich-gray">
          Now this course is available in the Course Market and has been moved to your ‘Published’, where you can check full comments. For
          assistance, contact us at support@hackquest.io. Thank you again for your support to build a better Web3 community!
        </div>

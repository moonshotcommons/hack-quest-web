...
const Apply: React.FC<ApplyProp> = () => {
  return (
    <div className="body-l mx-auto flex w-[755px] flex-col items-center gap-[40px] pt-[120px] text-neutral-off-black">
      ...
      <p>
        Our UGC Feature is still in Beta. If you fit any one of the descriptions
        below, please fill in the request form to upload your own courses here.
      </p>
      <ul className="w-full list-disc pl-[20px]">
        <li>KOL in an area</li>
        <li>
          Have produced contents/videos on other platforms like YouTube, Udemy,
          etc.
        </li>
      ...
      <div className="flex w-full justify-center gap-[16px]">
        ...
        <Link href={MenuLink.DASHBOARD}>
          <Button
            ghost
            className="button-text-l h-[60px] w-[270px]  border-neutral-black uppercase"
          >
            Cancel
          </Button>
        </Link>

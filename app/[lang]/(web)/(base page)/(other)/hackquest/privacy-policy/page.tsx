    ...
    <div className="w-full text-center text-text-default-color">
      ...
      <div className="body-xl mt-[4.5rem] flex flex-col gap-[12.5rem] text-left text-text-default-color">
        <div className="flex flex-col gap-[1.875rem]">
          <h1 className="text-h2 pb-[2.625rem] text-text-default-color">1. Data We Collect</h1>
          <p className="mt-[1.875rem]">When you visit the website, we may collect the following data</p>
          <ul className="flex list-disc flex-col gap-[0.725rem]">
            <li className="ml-6">Your IP address.</li>
            <li className="ml-6">Your contact information and email address.</li>
            <li className="ml-6">Other information such as interests and preferences.</li>
            <li className="ml-6">Data profile regarding your online behavior on our website.</li>
          </ul>
        </div>
        <div className="flex flex-col gap-[1.875rem]">
          <h1 className="text-h2 pb-[2.625rem]  text-text-default-color">2. Why We Collect Your Data</h1>
          <p className="mt-[1.875rem]">We are collecting your data for several reasons:</p>
          <ul className="flex list-disc flex-col gap-[0.725rem]">
...
agree to this privacy policy.`}
        ...
        <div className="flex flex-col gap-[1.875rem]">
          <h1 className="text-h2 pb-[2.625rem]  text-text-default-color">6. Intellectual Property Rights</h1>
          <p className="">
...
express prior written consent.`}
          ...
          <p className="">{`By accessing our courses, you agree not to reuse, sell, or commercially exploit our course content.`}</p>
          <p className="">
            {`For any inquiries or concerns, please contact us at `}{' '}
            <a href={'mailto:founder@hackquest.io'} target="_blank" className="underline">

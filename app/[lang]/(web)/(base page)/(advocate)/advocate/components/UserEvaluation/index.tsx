  ...
  return (
    <div className="mt-[6.25rem] w-full py-10">
      <div className="mx-auto flex w-[50rem] flex-col items-center gap-3 text-center">
        <h2 className="text-h2 text-neutral-off-black">we ❤️ our community advocates</h2>
        <p className="body-m text-neutral-medium-gray">Share your learning journey and tag us to be featured</p>
      </div>

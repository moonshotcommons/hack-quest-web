  ...
  return (
    <div className="flex h-[30rem] w-full items-center justify-center overflow-hidden bg-neutral-black">
      <div className="relative flex h-full flex-col items-center justify-center gap-[3.75rem] text-neutral-white">
        <h2 className="text-h2">{t('ConnectedUs.Stay Connected with us')}</h2>
        ...
        <div className="absolute -left-[calc(100%+200px)] -top-11 h-[30.1875rem] w-[29.4375rem]">
          <Image src={'/images/landing/connected_us_left.png'} alt="hackquest" fill></Image>
        </div>

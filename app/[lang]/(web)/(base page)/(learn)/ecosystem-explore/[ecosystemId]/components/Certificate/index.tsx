  ...
  return (
    <div className="flex items-center gap-[48px] rounded-[16px] bg-neutral-white p-[24px]">
      ...
      <div className="flex flex-shrink-0 items-center gap-[24px]">
        <div>
          <Image src={CertificateCover} alt={''} width={283} height={160} />
          <div className="body-m-bold mt-[14px] text-center">Lvl 1. Learner</div>
        </div>
        {ecosystem?.level?.level > 1 && (
          <>
            ...
            <div>
              <Image src={CertificateAcitveCover} alt={''} width={283} height={160} />
              <div className="body-m-bold mt-[14px] text-center">Lvl 2. Builder</div>
            </div>
          </>
        )}
      </div>

  ...
  return (
    ...
    >
      <div className="flex flex-1 flex-col gap-[16px] ">
        <h2 className="body-xl-bold text-neutral-black">{t(`developer.${type}`)}</h2>
        <p className="body-s text-neutral-medium-gray">{t(`developer.${type}Intro`)}</p>
      ...
      <div className="body-m flex flex-shrink-0 items-center gap-[32px] text-neutral-dark-gray">
        <span>{`${count} ${t(`developer.${type}`)}s`}</span>

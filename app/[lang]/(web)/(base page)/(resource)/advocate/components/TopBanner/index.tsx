    ...
    <div className="h-[50rem] overflow-hidden bg-neutral-off-black">
      <div className="container relative mx-auto px-10 py-20">
        <div className="absolute -left-[190px] -top-[286px] h-[1593px] w-[2013px]">
          <Image src={'/images/advocate/banner_bg.webp'} fill alt="hackquest"></Image>
        </div>
        <div className="mx-auto flex w-[800px] max-w-[800px] flex-col items-center gap-[60px] text-center">
          <div>
            ...
            <h1 className="text-h2 mt-2 text-neutral-white">{t('advocate.TopBanner.title')}</h1>
          </div>
          <p className="body-m text-neutral-light-gray">{t('advocate.TopBanner.description')}</p>
          ...
          <Link href={'https://xsxo494365r.typeform.com/to/X1n7gsPH'} target="_blank">
            <Button type="primary" className="button-text-l px-[55px] py-[19px] uppercase text-neutral-black">
              {t('advocate.TopBanner.apply')}
            </Button>
          </Link>
        </div>
      </div>

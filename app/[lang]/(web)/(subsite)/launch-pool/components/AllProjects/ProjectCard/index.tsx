...
const projectCardVariants = cva('rounded-[24px] w-full p-16 flex justify-between h-[644px] card-hover', {
  variants: {
    status: {
      [LaunchPoolProjectStatus.UPCOMING]: 'bg-neutral-off-white border border-dashed border-neutral-rich-gray',
      [LaunchPoolProjectStatus.AIRDROP]: 'bg-neutral-white border border-neutral-rich-gray',
      [LaunchPoolProjectStatus.ALLOCATION]: 'bg-neutral-white border border-neutral-rich-gray',
      [LaunchPoolProjectStatus.FUELING]: 'bg-neutral-white border border-neutral-rich-gray',
...
const ProjectCard: FC<ProjectCardProps> = async ({ lang, project, className }) => {
      ...
      <div className={cn(projectCardVariants({ className, status }))}>
        <div className="flex flex-col justify-center gap-6">
          ...
          <div className="flex flex-col gap-8">
            <p className="body-xl-bold text-neutral-off-black">{project.name}</p>

...
export const lessonTypeData: Record<string, { label: string; icon: ReactNode }> = {
  [LessonType.READING]: {
    label: 'Reading',
    icon: (
          ...
          rich_text: [
            {
              ...
              type: 'text',
              plain_text: 'Hyper Oracle is a decentralized protocol and network:',
              annotations: {
                bold: false,
                code: false,
                color: 'default',
...
export const labelMaps: Record<keyof CourseInformationType | keyof CourseContentType, string> = {

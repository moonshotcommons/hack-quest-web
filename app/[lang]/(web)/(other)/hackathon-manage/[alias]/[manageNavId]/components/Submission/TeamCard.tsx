...
const TeamCard: React.FC<TeamCardProp> = ({ member }) => {
  ...
  return (
    <div className="body-m flex w-full flex-col items-center gap-[16px] rounded-[16px] border border-neutral-light-gray bg-neutral-white p-[16px] text-neutral-off-black">

...
const CommonTable: React.FC<CommonTableProp> = ({ list, information, refresh, status: tabStatus }) => {
  ...
  return (
    <div className="flex w-full flex-1 flex-col">
      <Operation checkIds={checkIds} handleDown={handleDown} handleStatus={handleStatus} tabStatus={tabStatus} />
      <AuditTable
        checkIds={checkIds}

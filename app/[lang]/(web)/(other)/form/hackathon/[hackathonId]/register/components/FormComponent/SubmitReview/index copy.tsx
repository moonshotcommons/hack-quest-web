...
// import { CommonFormComponentProps, FormComponentProps } from '..';
...
//       onClick={() => gotoStep(0)}
//     >
//       <span className="body-l-bold flex-1 text-left">{isEmpty(applicationType.team) ? 'Name' : 'Team Name'}</span>
//       <span className="body-m flex-1 text-left">
//         {isEmpty(applicationType.team) ? name.firstName + ' ' + name.lastName : applicationType.team?.name}
//       </span>
//       {arrowIcon}
//     </div>
//   );

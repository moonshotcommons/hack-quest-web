      ...
      <div className="order-2 mt-5 flex flex-1 flex-col sm:order-1 sm:mt-0 sm:gap-6">
        ...
        <div className="flex flex-col sm:gap-2">
          <h2 className="mb-2 flex items-center gap-3 sm:mb-0">
            <span className="body-m-bold text-neutral-off-black sm:text-lg">Lvl {ecosystem.level.level}.</span>
        ...
        <Button
          ...
          className="mt-6 h-10 w-full whitespace-nowrap text-sm uppercase sm:mt-0 sm:h-12 sm:w-[11.25rem] sm:self-start"
        >

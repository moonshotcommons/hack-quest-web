...
//         <div className="overflow-hidden flex-1 h-full scroll-wrap-y no-scrollbar">
//           {passed ? (
...
//                     {codeText?.map((line: any, lineIndex: number) => {
//                       return (
//                         <li
//                           className="list-decimal w-full text-white font-thin whitespace-nowrap flex items-center justify-start"
//                           key={lineIndex}
//                         >

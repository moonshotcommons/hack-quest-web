...
const FeatureBlogCard: React.FC<FeatureBlogCardProp> = () => {
  return (
    <div className="w-full font-next-book h-[505px] overflow-hidden rounded-[10px]  flex shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)] cursor-pointer">
      <div className="w-[900px] relative  overflow-hidden">
        <Image src={Ha} fill alt="blogImage" className="object-contain"></Image>
      </div>

...
import LearningImage from '@/public/images/mantle/learning-image.svg';
...
const LearningTrackCard: React.FC<LearningTrackCardProps> = ({
        ...
        return (
          <>
            <div className="w-full flex items-center justify-between">
              <div className="w-[93%] bg-white rounded-[3px] h-[7px] overflow-hidden">
                <div
    ...
    if (isLandingPage) {
      return (
        <div className="flex-col-center h-full justify-center">
          <Button
            className="w-[80%] h-15 text-[18px] border border-[#CCE9E7] text-[#CCE9E7] px-0"
            onClick={handleRoll}
          >
            View Syllabus
          </Button>
          <Button
            type="primary"
            className="w-[80%] mt-5 h-15 text-[18px] text-home-learning-track-view-button-color "
  ...
  return (
    <div
      className="h-[275px] cursor-pointer rounded-[10px] overflow-hidden flex flex-col mb-10 hover:-translate-y-1 transition-all duration-300 shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)] hover:shadow-[0_8px_24px_rgba(149,157,165,0.2)]"
    ...
    >
      <div className="w-full flex-1 flex items-center p-10 relative">
        ...
        >
          ...
          <div className="flex flex-col h-full w-[77%] ">
            <div>
              <p className="text-white text-[18px] opacity-60">
                Learning Track
              </p>
              <p className="text-white tracking-[1.68px] font-bold text-[28px] mt-[5px]">
                {learningTrack?.name}
              </p>
            </div>
            ...
            <div className="w-full  text-[16px] text-white mt-[25px]">
              {leftRender()}
            </div>
          </div>
        </div>

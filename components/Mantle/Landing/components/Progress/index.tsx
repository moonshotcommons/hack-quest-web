...
const Progress: React.FC<ProgressProp> = () => {
  ...
  return (
    <div className={`text-white ${inter.className} mb-[30px]`}>
          ...
          <div key={i} className="w-[19.6%]">
            <div className="relative h-[25px]">
              {(schedule.curPeriod === i ||
                ...
                <div
                  className="absolute h-[40px] top-0 translate-x-[-100%] transition-all border-r border-r-[#5FA9A4] pr-[2px]"
                  style={{
                    left: `${(s[0] / s[1]) * 100}%`
                  }}
                >
            ...
            <div className="w-full h-[15px] bg-[#DADADA] mb-[14px]">
              <div
                className="h-[15px] bg-[#5FA9A4] shadow-[0_0_8px_#5FA9A4] transition-all"
                style={{
                  width: `${(s[0] / s[1]) * 100}%`
                }}
              ></div>

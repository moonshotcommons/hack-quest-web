...
const TipsModal: React.FC<TipsModalProp> = ({ open, onClose }) => {
  return (
    ...
    >
      <div className="flex-col-center  text-[#fff] py-[30px] bg-[#3E3E3E] shadow-[0px_4px_8px_0_rgba(0,0,0,0.12)] rounded-[10px] w-[90vw]">
        <p className="text-[48px]">😵</p>
        <p className="text-[20px] font-bold mt-[25px]">Laptop is preferred</p>

...
const CostCoinModal: ForwardRefRenderFunction<CostCoinModalRef, CostCoinModalProps> = (props, ref) => {
  ...
  return (
    open && (
      <div
        className="absolute flex h-full w-full items-center justify-center bg-[rgba(11,11,11,0.25)]"
        id="cost-coin-modal"
      >
        <div className="mx-6 flex w-full flex-col gap-6 rounded-[16px] bg-neutral-white p-6">

...
type CheckboxGroupElement = React.ElementRef<'div'>;
...
const CheckboxGroup = React.forwardRef<CheckboxGroupElement, CheckboxGroupProps>(
  (props: ScopedProps<CheckboxGroupProps>, forwardedRef) => {
    ...
    return (
      ...
      >
        <RovingFocusGroup.Root asChild {...rovingFocusGroupScope} orientation={orientation} dir={dir} loop={loop}>
          <div role="group" data-disabled={disabled ? '' : undefined} dir={dir} {...groupProps} ref={forwardedRef} />

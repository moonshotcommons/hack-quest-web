  ...
  return (
    <>
      ...
      >
              ...
              course.progress > 0 && (
                <CustomProgress
                  ...
                  format={(percent: any) => {
                    ...
                    return (
                      <p className="body-xs relative top-[1px] flex items-end justify-center whitespace-nowrap text-neutral-rich-gray">
        ...
        <h2 className="text-h4  mb-[9px] mt-[5px] line-clamp-1 text-neutral-black">
          {course.name}
        </h2>
        {!inProgress && (

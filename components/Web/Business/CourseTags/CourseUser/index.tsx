...
const CourseUser: React.FC<CourseUserProp> = ({ userImg = '', userName, className }) => {
  return (
    <div className={cn('body-xs flex w-full items-center gap-[4px] text-neutral-rich-gray', className)}>

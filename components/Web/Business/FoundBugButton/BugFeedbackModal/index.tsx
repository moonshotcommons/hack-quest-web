...
const BugFeedbackModal = forwardRef<BugFeedbackModalRef, BugFeedbackModalProps>(({ onSubmitSuccess }, ref) => {
  ...
  return (
    ...
    >
      <div className="max-w-[1084px ] w-[1084px] rounded-[16px] bg-neutral-off-white px-[139px] py-[64px]">
        <h1 className="text-h3 mb-4 text-center text-neutral-black">Report a Bug</h1>
        <p className="body-l text-neutral-medium-gray ">What kind of bugs have you found?</p>
        <Form ref={formRef} name="control-hooks">
          ...
          >
            ...
            <Input.TextArea
              ...
              className="body-m border-yellow-primary text-neutral-black shadow-none hover:border-yellow-primary focus:border-yellow-primary focus:shadow-none"
              // maxLength={500}
              onChange={(e) => {
            ...
            <p className="mt-[8px] text-right">
              <span className={descLength > 500 ? 'text-status-error' : ''}>{descLength || 0}</span>
              /500
            </p>
          </Form.Item>
          <Form.Item name={'files'} className="mt-[16 px] mb-[16px!important]">
            <Upload
              {...uploadProps}
              accept="image/*"
          ...
          <Form.Item>
            <Button
              ...
              className={cn(
                ...
                submitDisable ? 'bg- cursor-not-allowed bg-neutral-light-gray opacity-100' : ''
              )}
              block
              onClick={() => submit()}
            >

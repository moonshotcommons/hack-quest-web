...
const QuoteRenderer: FC<QuoteRendererProps> = (props) => {
  ...
  return (
    <div className="mb-[1.25rem] border-l-2 border-solid border-renderer-quote-border-color pl-[1.5rem] font-next-book text-[.875rem] leading-[128%] text-renderer-quote-text-color">

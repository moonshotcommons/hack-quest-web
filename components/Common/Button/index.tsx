...
> = (props) => {
  ...
  return (
    <button
      className={`flex gap-2 items-center whitespace-nowrap text-[#9EFA13] rounded-[2.5rem] bg-[#2A2A2A] text-[0.625rem] not-italic font-normal px-4 py-2 font-next-book-Thin`}
      {...rest}
    >
      {icon}
      <span>{children}</span>

...
const SignUpStreak: React.FC<SignUpStreakType> = ({ daysData }) => {
  const { exp, progress } = daysData;
  return (
            ...
            return i < progress?.progress[0] ? (
              ...
              >
                ...
                {progress.claimed ? (
                  ...
                  <button className="flex-center w-[79px] h-[40px] bg-mission-center-tab-btn-claimed-bg text-mission-center-tab-btn-claimed-color rounded-[12px]">
                    Claim
                  </button>
                )}
              </div>

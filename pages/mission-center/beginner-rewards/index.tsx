  ...
  return (
    <div className="h-[500px] rounded-[20px] px-[28px] py-[40px] bg-mission-center-box flex justify-between">
      ...
      <div className="flex flex-col justify-between">
        <div className="relative w-[412px] flex justify-between h-[132px] bg-mission-center-beginner-bg rounded-[20px] px-5 py-[13px]">
          ...
          <div className="w-[57px] h-full flex-col-center justify-between relative">
            ...
            <div className="flex-col-center">
              <Image
                ...
                unoptimized
              />
              <span className="font-next-book-bold">25</span>
            </div>
          </div>
          <div className="flex flex-col justify-between w-[252px]">
            <p className="leading-[14px]">Join our Discord community</p>
            <div className="flex justify-end">
              <button className="base-btn w-[auto] text-mission-center-beginner-btn-color bg-mission-center-beginner-btn-bg px-[21px]">
                Join Now
              </button>
            </div>
          </div>
        ...
        <div className="relative w-[412px] flex justify-between h-[132px] bg-mission-center-beginner-bg rounded-[20px] px-5 py-[13px]">
          <div className="absolute left-0 top-0 w-[116px] h-[132px] text-mission-center-beginner-svg">
            <svg
              ...
              height="132"
              viewBox="0 0 116 132"
              className="mission-center-icon-user-color"
              fill="none"
            >
              <path
                d="M0 20C0 8.9543 8.95431 0 20 0H116L80.438 132H20C8.9543 132 0 123.046 0 112V20Z"
          ...
          <div className="flex flex-col justify-between w-[252px]">
            <p className="leading-[14px]">
              Updates profile pictures and <br />
              username
            </p>
            <div className="flex justify-end">
              <button className="base-btn w-[auto] text-mission-center-beginner-btn-color bg-mission-center-beginner-btn-bg px-[21px]">
        ...
        <div className="relative w-[412px] flex justify-between h-[132px] bg-mission-center-beginner-bg rounded-[20px] px-5 py-[13px]">
          ...
          <div className="flex flex-col justify-between w-[252px]">
            <p className="leading-[14px]">Link Metamask xxx xxx</p>
            <div className="flex justify-end">
              <button className="base-btn w-[auto] text-mission-center-beginner-btn-color bg-mission-center-beginner-btn-bg px-[21px]">
                Link
              </button>
